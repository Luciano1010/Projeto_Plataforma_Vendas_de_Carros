            ...
            {cars.map(car => (
               <section key={car.id} className="w-full bg-white rounded-lg relative">
                  ...
                  <button
                     ...
                     className="absolute bg-white w-10 h-10 rounded-full flex items-center justify-center right-3 top-3 drop-shadow"
                  >
                     <FiTrash2 size={22} color="#000" />
                  </button>

                  <img
                     className="w-full rounded-lg mb-2 max-h-70 p-2"
