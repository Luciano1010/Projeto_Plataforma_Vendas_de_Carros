...
const schema = z.object({
  ...
  whatsapp: z.string().min(6, "O telefone é obrigatório").refine((value) => /^\d{11,12}$/.test(value), {
...
export function New() {
  ...
  function onSubmit(data: FormData) {
    if(carImages.length === 0){
      alert("Envie alguma imagem desse Veiculo")
      return;
    }
        ...
        {carImages.map( item =>(
          <div key={item.name} className="w-full h-32 flex items-center justify-center relative">
            <button className="absolute top-0 right-0" onClick={() => handleDeleteImage(item) }>
              ...
              <img
                src={item.previewUrl}
                className="rounded-lg w-full h-32 object-over"
                alt="Foto do carro"
              />
          </div>
        ))}
        ...
        >
          ...
          <div className="mb-3">
            ...
            <Input
              ...
              placeholder="Ex... Onix 1.0 plus manual"
            />
          </div>
          <div className="flex w-full flex-row items-center gap-4">
            <div className="w-full">
              ...
              <Input
                ...
                placeholder="Ex... Onix 1.0 plus manual - 2016"
              />
            </div>
            ...
            <div className="w-full">
              ...
              <Input
                ...
                placeholder="Ex... Onix 1.0 plus manual - 2016 - 120.000KM"
              />
            </div>
